...
pickle.dump(user2user_encoded, open('user2newUser_map.pkl', 'wb'))
pickle.dump(userencoded2user, open('newUser2user_map.pkl', 'wb'))
pickle.dump(movie2movie_encoded , open('movie2newMovie_map.pkl', 'wb'))
pickle.dump(movie_encoded2movie, open('newMovie2movie_map.pkl', 'wb'))
